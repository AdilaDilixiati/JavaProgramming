...
import javax.swing.*;
        public class Flag extends JPanel {
            ...
            public static void starMoon(Color bg) {
            ...
            private static Flag grid = new Flag(60);
            private static int r = grid.getHt(),  c = grid.getWd(),size = 6,  sH = r / size,
