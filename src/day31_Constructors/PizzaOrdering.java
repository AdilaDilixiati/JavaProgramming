...
public class PizzaOrdering {
    ...
    public static void main(String[] args) {
        ...
        //create 100 pizza objects: size-'S', cheese topping-2, sucuk topping-3
        //create 100 pizza objects: size-'M', cheese topping-3, sucuk topping-4
        //create 100 pizza objects: size-'L', cheese topping-4, sucuk topping-5
